...
void SystemPropertiesHook::init(JNIEnv *env) {
    ...
    prop_map.insert(map<std::string, std::string>::value_type("ro.build.display.id",
                                                              "QKQ1.191117.002 test-keys"));
    prop_map.insert(
            map<std::string, std::string>::value_type("ro.build.host", "c5-miui-ota-bd074.bj"));
